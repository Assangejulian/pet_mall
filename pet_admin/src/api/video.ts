...
export function updateVideo(id: string, data: Partial<Video>): Promise<void> { return unwrap(http.put("/video/" + id, data)) }
export function deleteVideo(id: string): Promise<void> { return unwrap(http.delete("/video/" + id)) }
