...
Page({
  ...
  onSendSms: function () {
    ...
    this.setData({ smsCountdown: 60, canSendSms: false });
    var t = this;
    var i = setInterval(function () {
      var c = t.data.smsCountdown - 1;
      if (c <= 0) { clearInterval(i); t.setData({ smsCountdown: 0, canSendSms: true }); }
  ...
  onPasswordLogin: function () {
    ...
    var t = this;
    authApi.login({ authType: "password", username: p, password: this.data.password })
      .then(function (r) { t.doLogin(r); });
  },
  ...
  onSmsLogin: function () {
    ...
    var t = this;
    authApi.login({ authType: "sms", phone: p, code: this.data.smsCode })
      .then(function (r) { t.doLogin(r); });
  },
