...
<template>
  <section class="home-prototype">
    ...
    <div class="home-hero">
      ...
      <div class="home-hero-inner">
        <div class="home-hero-copy">
          <p class="hero-tag">♡ 今天也有人等你</p>
          <h1>每一个生命<br />都值得被<em>温柔接住</em></h1>
          <p>它们不是路过的风景，是会慢慢照亮日子的家人。</p>
    ...
    <section class="home-section">
      <div class="home-section-head">
        <div>
          ...
          <h2>它们都在等你</h2>
          <p>慢慢看，别着急。也许下一张，就是让你忍不住停下来小朋友。</p>
        </div>
    ...
    <section class="home-section">
      <div class="home-section-head">
        <div>
          <p class="eyebrow">身边的温暖</p>
          <h2>离你最近的陪伴</h2>
          <p>每一家门店，都有小家伙在认真生活。</p>
        </div>
